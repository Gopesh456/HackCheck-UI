...
// Changed transition to be faster
const transition = {
  duration: 0,
  ease: "easeOut", // Changed from "linear" to make it feel more responsive
};
...
export const GoogleGeminiEffect = ({
  ...
  return (
    <div
      className={cn(
        "relative min-h-[600px] w-full flex flex-col items-center bottom-2",
        className
      )}
    >
      {/* Text content at the top */}
      <div className="relative z-10 pt-8">
        <p className="pb-4 text-lg font-bold text-center text-transparent md:text-7xl bg-clip-text bg-gradient-to-b from-[#FFD700] to-[#B8860B]">
          <TypewriterEffectSmooth words={words} />
        </p>
        <p className="max-w-lg mx-auto mt-4 text-xs font-normal text-center md:text-xl text-neutral-400">
          {description ||
        ...
        <div className="w-full h-[890px] -top-60 md:-top-40  flex items-center justify-center bg-red-transparent absolute ">
          <button
            ...
            className="px-8 py-4 font-bold text-gray-900 rounded-full shadow-lg group bg-gradient-to-r from-amber-500 to-yellow-500 hover:from-amber-600 hover:to-yellow-600 hover:scale-105 hover:shadow-xl"
          >
            Login Now
      ...
      {/* SVG in background */}
      <div className="absolute inset-0 z-0 w-full  h-full top-[-4rem]">
        <svg
          width="1440"
          height="890"
