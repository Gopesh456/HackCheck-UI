...
const SpotlightCard = ({
  ...
  return (
    ...
    >
      {/* Main Spotlight */}
      <div
        className="absolute transition-opacity duration-300 opacity-0 pointer-events-none -inset-px"
        style={
          {
            opacity,
      ...
      {glowEffect && (
        <div
          className="absolute transition-opacity duration-300 opacity-0 pointer-events-none -inset-px blur-xl"
          style={
            {
